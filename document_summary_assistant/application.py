...
"""Flask application assembly for the Document Summary Assistant."""
...
from document_summary_assistant.web import blueprint
from document_summary_assistant.web import handle_large_upload
